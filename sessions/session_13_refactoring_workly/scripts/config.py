"""
Configuration manager for Workly.
...
class Config:
    ...
    def _get_default_config(self) -> Dict[str, Any]:
        ...
        """
        return {
            "unity": {"host": "127.0.0.1", "port": 5555},
            "audio": {"sample_rate": 44100, "buffer_size": 1024, "device": None},
            "avatar": {
                "last_model": None,
                "default_model": None,
                "auto_blink": {
            ...
            "window": {"width": 800, "height": 600, "x": 100, "y": 100},
        }
