...
class ChatEngine:
    ...
    def _build_prompt(self, user_input: str, history: List[Dict[str, Any]], 
    ...
    def chat(
        ...
        context_analysis = self.context_analyzer.analyze(
            user_input, conversation_history=[msg["content"] if isinstance(msg, dict) and "content" in msg else msg.get("user_input", "") for msg in history[-5:]]
        )
        logger.debug(
